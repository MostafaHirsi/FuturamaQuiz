...
class _$_Character implements _Character {
  ...
  @override
  String toString() {
    return 'Character(id: $id, age: $age, gender: $gender, species: $species, homePlanet: $homePlanet, occupation: $occupation, sayings: $sayings, name: $name, images: $images)';
  }
...
class _$_Images implements _Images {
  ...
  @override
  String toString() {
    return 'Images(headShot: $headShot, main: $main)';
  }
